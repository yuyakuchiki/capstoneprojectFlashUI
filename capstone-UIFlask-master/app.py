...
def index():
    ...
    stats = {
        ...
        'rev_table' : playstore.groupby(['Category','App'])['Reviews','Rating'].sum().sort_values('Reviews', ascending=False).head(10).reset_index().to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
